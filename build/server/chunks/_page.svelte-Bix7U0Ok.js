import { c as create_ssr_component, b as subscribe, j as set_store_value, v as validate_component, k as add_attribute, e as each, a as escape } from './ssr-BPpBco92.js';
import { g as globals, c as createTable, R as Root$1, S as Select_trigger, V as Value, a as Select_content, b as Select_item, d as Root, T as Trigger, C as Chevron_down, D as Dropdown_menu_content, e as Dropdown_menu_checkbox_item, f as Subscribe, h as Render, i as addHiddenColumns } from './postcss-BWBkhg9_.js';
...
import { w as writable } from './index4-BsPMz3xn.js';
import './client-BUusD8wq.js';
import './index5-4H_RKGxQ.js';
import './index6-CwU3zv22.js';
import './check-B7hBTfZC.js';
import './Icon-Cvl7DYRt.js';
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `<main class="bg-white min-h-[90svh] text-black"> <div class="w-[90%] mx-auto mt-10 mb-2 flex items-center gap-3">${validate_component(Root$1, "Select.Root").$$render(
      ...
      "href",
      pageNumber > 1 ? "non-participants?page=" + (data.page - 1) + "&limit=" + data.limit : "",
      0
      ...
      "href",
      pageNumber < Math.ceil(data.count / data.limit) ? "non-participants?page=" + (data.page + 1) + "&limit=" + data.limit : "",
      0
...
//# sourceMappingURL=_page.svelte-Bix7U0Ok.js.map
