...
import { g as globals, c as createTable, R as Root$1, S as Select_trigger, V as Value, a as Select_content, b as Select_item, d as Root$2, T as Trigger, C as Chevron_down, D as Dropdown_menu_content, e as Dropdown_menu_checkbox_item, f as Subscribe, h as Render, i as addHiddenColumns } from './postcss-W62CLXpL.js';
...
import { c as createRender, B as ButtonWrapper, R as Root, D as Dialog_content, a as Dialog_header, b as Dialog_title, d as Dialog_description } from './ButtonWrapper-t3l30B86.js';
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `<main class="bg-white min-h-[90svh] text-black"><div>${validate_component(Root, "Dialog.Root").$$render(
      $$result,
      { open: ssopen },
      {
        open: ($$value) => {
    ...
    )}</div>  <div class="w-[90%] mx-auto mt-10 mb-2 flex items-center gap-3">${validate_component(Root$1, "Select.Root").$$render(
      $$result,
      {
        onSelectedChange: (v) => {
          data.limit = v?.value;
    ...
    )} <a${add_attribute("href", "verified?page=1&limit=" + data.limit + "&filter=" + data.filter, 0)}>${validate_component(Button, "Button").$$render($$result, {}, {}, {
      default: () => {
        return `Apply`;
      }
      ...
      "href",
      data.pageNumber > 1 ? "verified?page=" + (data.pageNumber - 1) + "&limit=" + data.limit : "",
      0
      ...
      "href",
      data.pageNumber < Math.ceil(data.count / data.limit) ? "verified?page=" + (data.pageNumber + 1) + "&limit=" + data.limit : "",
      0
...
//# sourceMappingURL=_page.svelte-y6cQtb8B.js.map
